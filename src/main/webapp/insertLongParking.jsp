				...
				<table class="info">
					...
					<tr>
						...
						<input type="button" value="시작날짜" id="sdate" name="parking_intime"  /> 
						 -->
						<input type="date" value="시작날짜"  name="parking_intime" id="parking_intime" min="2021-04-20" max="2021-05-20" required/> 
						</td>
					</tr>
					...
					<tr>
						...
						<input type="button" value="종료날짜" id="edate" name="parking_outtime"/>
						 -->
						<input type="date" value="종료날짜"  name="parking_outtime" id="parking_outtime" min="2021-04-20" max="2021-05-20" required/>
